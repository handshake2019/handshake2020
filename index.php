 ...
 <!-- Left and right controls -->
  ...
  <section class="page-section" id="about">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Como funciona o Handshake?</h2>
          <h3 class="section-subheading text-muted">Aprenda como utilizar as funcionalidades do Handshake com o tutorial abaixo.</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
  ...
  <section class="bg-light page-section" id="team">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Conheça a nossa incrível equipe</h2>
          <h3 class="section-subheading text-muted">A equipe Handshake deseja a sua satisfação músical, somos focados em fazer o melhor, para que você alcance o que tanto almeja.</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-4">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="img/team/jhonata.jpeg" alt="">
            <h4>Jhônata</h4>
        ...
        <div class="col-sm-4">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="img/team/lucas.png" alt="">
            <h4>Lucas</h4>
        ...
        <div class="col-sm-4">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="img/team/matheus.jpeg" alt="">
            <h4>Matheus</h4>
        ...
        <div class="col-sm-6">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="img/team/victor.png" alt="">
            <h4>Victor</h4>
         ...
         <div class="col-sm-6">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="img/team/washington.jpeg" alt="">
            <h4>Washington</h4>
            <p class="text-muted">Eng. Software</p>
            <ul class="list-inline social-buttons">
              <li class="list-inline-item">
                <a href="#">
                  <i class="fab fa-twitter"></i>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          ...
          <h3 class="section-subheading text-light">Você pode entrar em contato conosco através do nosso número ou nosso e-mail, independentemente da forma, iremos lhe atender! Nosso suporte funciona 24 hrs por dia.</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          <form id="contactForm" name="sentMessage" novalidate="novalidate">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <input class="form-control" id="phone" type="tel" placeholder="Seu contato *" required="required" data-validation-required-message="Please enter your phone number.">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              <div class="col-md-6">
